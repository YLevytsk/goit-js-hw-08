// Импорт библиотеки basicLightbox (если используете npm)
...
// Получаем ссылку на элемент ul с классом "gallery"
const galleryContainer = document.querySelector('.gallery');

// Создаем разметку для галереи на основе массива данных
...
// Добавляем обработчик событий на контейнер галереи
galleryContainer.addEventListener('click', event => {
  ...
  // Создаем модальное окно с помощью basicLightbox
